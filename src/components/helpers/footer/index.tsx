...
const Footer: React.FC<FooterProps> = (props) => {
  ...
  return (
    <>
      <footer className="relative z-10 w-full bg-blue-secondary">
          ...
          <div className="-mx-4 flex  flex-row">
            <div className="w-full px-4">
              <div className="mb-10 w-full">
                ...
                <p className="flex items-center text-sm font-medium text-custom_grey dark:text-white">
                  ...
                  <span>+918043003611<br/>enquiry@gkcloud.ai</span>
                  <span></span>
                </p>
              </div>
            </div>
            ...
            <div className="w-full px-4">
              <div className="mb-10 w-full">
                <h4 className="mb-9 text-lg font-semibold text-custom_grey">
                  Follow Us On
                </h4>
                ...
                <p className="text-base text-custom_grey dark:text-custom_grey-6">
                  &copy; 2025 GK Cloud Solutions
                </p>
              </div>
            </div>
          </div>
...
const LinkGroup = ({ children, header }:{children:any,header:any}) => {
  return (
    <>
      <div className="w-full px-4">
        <div className="mb-10 w-full">
          <h4 className="mb-9 text-lg font-semibold text-custom_grey dark:text-white">
            {header}
          </h4>
