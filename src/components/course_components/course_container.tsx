...
export default function CourseContainer() {
  ...
  return (
    <main className="w-full bg-primary_color flex-1 flex flex-col justify-start items-start">
      ...
      {name != null && (name == "AI" || name == "Artificial Intelligence") ? (
        <section className="w-full mt-10 flex flex-col justify-start items-start gap-6">
          ...
          <div className=" object-cover w-full flex flex-row items-center justify-center">
            <img alt="ai" className="mx-auto h-auto  md:h-144" src="/ai.png" />
          </div>
        </section>
      ) : type != null &&
        type == "partner" &&
      ...
      ) : name != null && (name == "Microsoft Azure" || name == "Microsoft") ? (
        <section className="w-full mt-10 flex flex-col justify-start items-start gap-6">
          <h2 className="text-3xl text-blue font-semibold">{name}</h2>

          <div className=" object-contain w-full flex flex-row items-center justify-center">
            <img alt="azure" className="mx-auto h-auto md:h-128" src="/azure.png" />
          </div>
        </section>
      ) : (
        <></>
      ...
      {index == 0 ? (
        <div className="box-border border w-full p-8 border-blue border-1 bg-dark_blue rounded-2xl">
          ...
          <section className="mt-10 flex flex-row flex-wrap gap-6">
      ...
      <section className="w-full my-10 flex flex-row items-center justify-center">
        {loadMore >=
        (index == 0 ? courseList.length : certificateList.length) ? (
          <></>
        ) : (
          <NormalBtn
            text={"Load More"}
