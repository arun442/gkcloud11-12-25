  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
        subject: Yup.string()
            ...
            .matches(/^[a-zA-Z0-9 ._\-,()\[\]:&-_@*%!'$©®₹"`~]+$/, 'Please enter a valid subject'),
    
        message: Yup.string()
            .required('Please enter a valid message')
            .matches(/^[a-zA-Z0-9 ._\-,()\[\]:&-_@*%!'$®©₹"`~]+$/, 'Please enter a valid message'),
    }),
    ...
    <ProfileLayout>
      <main className="w-full h-full flex flex-col">
        ...
        <form
          ...
          className="flex-1 w-full flex-col mt-12"
        >
          ...
          <div className="w-full flex justify-center items-center">
            <button
              type="submit"
              className=" flex  justify-center rounded bg-blue py-2 px-6 font-medium text-white "
            >
