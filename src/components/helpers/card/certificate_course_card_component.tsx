  ...
  return (
    ...
    >
      <section className="flex-1 flex-col">
        <span className="text-white text-xl font-medium">{data.Course.title}</span>
        ...
        >
          ...
          >
            <div className="mt-4  w-full flex justify-end items-end">
              <img src={`${commonbasePath}/popclose.png`} alt="close" style={{height:'40px'}} onClick={closePopup} className="pointer"/>
